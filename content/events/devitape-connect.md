...
- **Felipe KiKo** — Arquiteto Cloud
- **Willian Alves** — SRE na Turbi
- **Vinicius Zevarex** — Backend na Power One
- **Paulo Cândido** — Tech Lead na Totvs

### 👥 Para quem é

Estudantes de tecnologia, desenvolvedores em início ou meio de carreira, profissionais de infraestrutura e qualquer pessoa curiosa para entender como sistemas grandes são construídos e mantidos no ar.
...
- **Inscrição:** gratuita pelo Sympla, com vagas limitadas

Vem com a gente. Nos vemos no **DevItape Connect**!

**Realização:** DevItape, Fatec Itapetininga e Centro Paula Souza.
