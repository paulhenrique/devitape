        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li><Link href="/equipe" className="hover:text-purple-400 transition-colors">Equipe</Link></li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <Link href="/go/whatsapp" target="_blank" className="text-muted-foreground hover:text-foreground transition-colors" title="WhatsApp">
